...
({free_gb:.1f}GB libre)'
 return 'ok', f'Disco saludable: {used_pct:.1f}% usado ({free_gb:.1f}GB 
libre)'
...
def check_backup(backup_dir: str = 'backups', max_age_hours: int = 25):
 ...
 return 'warning', f'Backup más reciente tiene {age_hours:.1f}h (máx: 
{max_age_hours}h)'
...
def run_all_checks() -> dict:
 ...
 # Estado general: 'error' si cualquier check falla, 'warning' si alguno 
advierte
